...
public:
  ros::NodeHandle nh;
  ros::Publisher atiforce_pub_ = nh.advertise<ati_ft_ethernet::FTsensor>("/atiforce/ftsensor",1);
  ...
  void ftPublish(Response r)
  {
    ft_msg_.Fx = (double)r.FTData[0]/1000000.0;
    ft_msg_.Fy = (double)r.FTData[1]/1000000.0;
    ft_msg_.Fz = (double)r.FTData[2]/1000000.0;
    ft_msg_.Tx = (double)r.FTData[3]/1000000.0;
    ft_msg_.Ty = (double)r.FTData[4]/1000000.0;
    ft_msg_.Tz = (double)r.FTData[5]/1000000.0;

    atiforce_pub_.publish(ft_msg_); 
  }

  ati_ft_ethernet::FTsensor ft_msg_;
